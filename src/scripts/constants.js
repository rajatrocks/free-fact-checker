...
export const GEMINI_MODELS = [
    ...
    { id: "gemini-2.5-flash-lite", name: "Gemini 2.5 Flash Lite  (20/day)" },
    { id: "gemini-3.5-flash", name: "Gemini 3.5 Flash  (20/day)" },
    { id: "gemini-3.5-flash-lite", name: "Gemini 3.5 Flash Lite  (500/day)" },
    { id: "gemini-3.6-flash", name: "Gemini 3.6 Flash  (20/day)" },    
];
